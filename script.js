...
function akingfunction() {
    ...
    setTimeout(function() {
        alert("Hey Jam, just a little reminder to take a deep breath and know that it’s okay to take things one step at a time. You’ve got this, and I’m here for you!");
